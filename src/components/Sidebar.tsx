...
import { BarChart3, Settings, Mail, Phone, FileText, Clock, LogOut } from "lucide-react";
                                    ...
                                    {item.children.map((child) => (
                                        <Link
                                            ...
                                            className={`flex items-center px-3 py-2 rounded-md text-sm transition-colors duration-200 ${
                                                isActive(child.href) ? "text-[#e1a730] font-medium" : "text-gray-400 hover:text-gray-200"
                                            }`}
                                        >
