            ...
            <div className="max-w-4xl space-y-6">
                            ...
                            <div className="bg-gray-50 p-6 rounded-lg">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div>
                                        ...
                                        <span
                                            className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${getSentimentColor(selectedCall.sentiment)}`}
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="text-gray-900 bg-white p-4 rounded border">{selectedCall.summary}</div>
                                </div>
                            </div>
                ...
                <Card title="Email Configuration">
                    <div className="space-y-4 text-sm">
                        ...
                        <div className="text-gray-700">This email would be automatically sent after each call from monitored numbers.</div>
                    </div>
                </Card>
            </div>
        </div>
