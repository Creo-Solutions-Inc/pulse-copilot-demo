...
import { Search, Filter, Phone, TrendingUp, TrendingDown, Minus, ArrowRight, ChevronDown } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">Call List</h1>
                    <p className="text-lg text-gray-600">View all calls from the past 30 days</p>
                </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full">
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-32">Time</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-44">Internal #</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-44">External #</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-28">Call Type</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-32">Call Outcome</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-32">Sentiment</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-20">Action</th>
                                    </tr>
                                </thead>
                                    ...
                                    {filteredCalls.map((call) => (
                                        ...
                                        >
                                            <td className="px-6 py-4 text-sm text-gray-900 font-medium">
                                                {new Date(call.time).toLocaleDateString("en-GB")},{" "}
                                                {new Date(call.time).toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit", second: "2-digit" })}
                                            </td>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-900">
                                                <span
                                                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                                        call.callOutcome === "Completed" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                                    }`}
                                                >
                                                    {call.callOutcome}
                                                </span>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center">
                                                    <span
                                                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getSentimentColor(call.sentiment)}`}
                                                    >
