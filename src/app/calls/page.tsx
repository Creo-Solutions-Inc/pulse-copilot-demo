                  ...
                  {filteredCalls.map((call) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm text-gray-900 font-medium">
                        {new Date(call.time).toLocaleDateString('en-GB')}, {new Date(call.time).toLocaleTimeString('en-GB', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
                      </td>
