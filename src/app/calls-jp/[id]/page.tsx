    ...
    return (
      <div className="p-8">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/calls-jp')}>
            通話リストに戻る
          </Button>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="font-medium text-gray-900">
                  {new Date(call.time).toLocaleString('ja-JP')}
                </div>
              </div>
            </div>
          </Card>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getSentimentColor(call.sentiment)}`}>
