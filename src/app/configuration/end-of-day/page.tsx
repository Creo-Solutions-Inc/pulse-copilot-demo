...
import { Save, CheckCircle, Info, AlertTriangle, Clock, Calendar, Mail, Eye, FileText } from "lucide-react";
...
export default function EndOfDayConfigPage() {
    ...
    const previewData = {
        ...
        qualityScore: 78,
        topActionItems: ["Follow up with 5 prospects", "Schedule 3 demos for next week", "Update customer preferences for 8 accounts"],
    };
                    ...
                    >
                        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                            ...
                            <div className="space-y-4 text-gray-800">
                                <div>{config.intro || "Your daily summary of all calls, including key metrics and action items for tomorrow."}</div>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded">{config.sendTime || "18:00"}</span>
                                        </div>

                                        <div className="flex items-center justify-between">
                                            <span className="font-medium text-gray-700">Trigger:</span>
                                            <span className="text-sm bg-purple-100 text-purple-800 px-2 py-1 rounded">Daily Scheduled Summary</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border-t border-gray-200 pt-4 mt-6">
                                    <p className="text-sm text-gray-700">For full email preview with daily data, visit the Mail Box section.</p>
                                </div>
                            </div>
                        </div>
                    </Card>
