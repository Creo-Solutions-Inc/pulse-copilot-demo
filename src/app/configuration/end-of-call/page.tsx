          ...
          <Card title="Email Settings">
            ...
            <div className="mt-8 flex items-center justify-between">
              <div className="text-sm text-gray-700">
                Changes will apply to all new call summaries
              </div>
          ...
          <Card title={
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              {/* Configuration Preview */}
                  ...
                  <div>
                    {config.intro || 'Here\'s a summary of your recent call with detailed insights and action items.'}
                  </div>
                ...
                <div className="border-t border-gray-200 pt-4 mt-6">
                  <p className="text-sm text-gray-700">
                    For full email preview with call data, visit the Mail Box section.
                  </p>
                </div>
              </div>
            </div>
